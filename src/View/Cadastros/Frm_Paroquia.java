 ...
 * @author Tadeu
 */
public class Frm_Paroquia extends javax.swing.JFrame {
    ...
    public int getCodParoquia() {
        int codparoquia = 0;
        try {
            rs = manager.consulta("SELECT MAX(CODPAROQUIA) QTDE FROM PAROQUIA");
            while (rs.next()) {
                codparoquia = Integer.parseInt(rs.getString("qtde")) + 1;
            }
        } catch (Exception e) {
    ...
    public void salva(String descricao) {
        try {
            if (txt_descricao.getText().replaceAll(" ", "").compareTo("") == 0) {
                JOptionPane.showMessageDialog(null, "Descrição Inválida");
                txt_descricao.setText("");
                txt_descricao.requestFocus();
            } else {
                manager.insere("INSERT INTO PAROQUIA (CODPAROQUIA,NOME) VALUES("+getCodParoquia()+",'" + descricao + "')");
                JOptionPane.showMessageDialog(null, "Paroquia Salva com Sucesso\n");
                txt_descricao.setText("");
                txt_descricao.requestFocus();
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Paroquia Inválida\n" + e.getMessage());
        }
    ...
    private void btn_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_salvarActionPerformed
        salva(txt_descricao.getText().toUpperCase().trim());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_Paroquia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_Paroquia().setVisible(true);
            }
        });
    }
